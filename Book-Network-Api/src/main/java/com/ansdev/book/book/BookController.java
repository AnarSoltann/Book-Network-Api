...
public class BookController {
    ...
    public ResponseEntity<Integer> updateShareable(@PathVariable("book-id") Integer bookId,
                                                   Authentication connectedUser) {
    ...
    public ResponseEntity<Integer> approveReturnedBorrowBook(@PathVariable("book-id") Integer bookId,
                                                             Authentication connectedUser) {
